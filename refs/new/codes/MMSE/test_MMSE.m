...
#DataSym3
for ii=1:(UsedPilotSymbsLen)
pilot_sym(ii) = mapping(UsedPilotSymbs(ii,1),UsedPilotSymbs(ii,2),UsedPilotSymbs(ii,3),s_comp);   % 8-PSK modulation
end
#pilot_sym
% 
...
m_psk(ii) = mapping(UsedPilotSymbs(ii,1),UsedPilotSymbs(ii,2),UsedPilotSymbs(ii,3),s_comp);   % 8-PSK modulation
end
#             for ii=1:(PayloadSymbsLen/2)
#                 DataSym3(ii)=bi2de(UsedPilotSymbs(ii,:),'left-msb')+1;
#             end
