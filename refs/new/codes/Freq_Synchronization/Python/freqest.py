...
#plt.legend(loc='best')
#plt.grid()
#plt.savefig("./figs/frequencyestiamtion_best_error_vs_snr.eps")
#plt.savefig("./figs/frequencyestiamtion_best_error_vs_snr.pdf")
#subprocess.run(shlex.split('termux-open ./figs/frequencyestiamtion_best_error_vs_snr.pdf'))
