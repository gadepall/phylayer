...
t_pilot = pilot_bits*bit_duration; #Pilot duration in seconds
...
mac_overhead_bits = floor(t_mac_overhead/bit_duration);

#Verifying frame duration
bal_duration = frame_duration-(t_ramp+t_prop_delay+t_som+t_payload+t_mac_overhead+t_pilot);
floor(bal_duration/bit_duration)
